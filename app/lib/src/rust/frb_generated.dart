...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1002805412;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<bool> crateApiAutostartAutostartEnabled();
  ...
  Future<bool> crateApiAutostartSetAutostart({required bool enabled});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<bool> crateApiAutostartAutostartEnabled() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAutostartAutostartEnabledConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAutostartAutostartEnabledConstMeta =>
  ...
  Future<List<BridgeHistoryEntry>> crateApiHistoryHistoryList({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_bridge_history_filter(filter, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 17,
  ...
  Future<bool> crateApiAutostartSetAutostart({required bool enabled}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAutostartSetAutostartConstMeta,
        argValues: [enabled],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAutostartSetAutostartConstMeta =>
  ...
  Future<bool> crateApiEngineWatchHold({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_list_prim_u_32_loose(vks, serializer);
          sse_encode_bool(stopOnEarlyRelease, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 41,
  ...
  @protected
  BridgeHistoryFilter dco_decode_box_autoadd_bridge_history_filter(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_history_filter(raw);
  }
    ...
    switch (raw[0]) {
      ...
      case 6:
        return BridgeCommand_SetStyleDirective(
          ...
          scenario: dco_decode_opt_String(raw[2]),
        );
      case 7:
      ...
      case 11:
        return BridgeCommand_RectifyText(
          ...
          sourceSessionId: dco_decode_opt_box_autoadd_i_64(raw[3]),
        );
      default:
  ...
  BridgeEvent dco_decode_bridge_event(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 6:
        return BridgeEvent_RectifyThinkingDelta(
  ...
  BridgeHistoryEntry dco_decode_bridge_history_entry(dynamic raw) {
    ...
    return BridgeHistoryEntry(
      ...
      scenarioId: dco_decode_opt_box_autoadd_i_64(arr[4]),
    );
  }
  ...
  BridgeHistoryFilter dco_decode_bridge_history_filter(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeHistoryFilter_All();
      case 1:
        return BridgeHistoryFilter_DefaultRegister();
      case 2:
        return BridgeHistoryFilter_Scenario(dco_decode_i_64(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  BridgeLlmConnection dco_decode_bridge_llm_connection(dynamic raw) {
    ...
    return BridgeLlmConnection(
      ...
      key: dco_decode_bridge_key_status(arr[4]),
      keys: dco_decode_list_bridge_llm_vendor_key(arr[5]),
      thinkingState: dco_decode_String(arr[6]),
      thinkingDetail: dco_decode_opt_String(arr[7]),
      bodyJson: dco_decode_opt_String(arr[8]),
      thinkingOnJson: dco_decode_opt_String(arr[9]),
      thinkingOffJson: dco_decode_opt_String(arr[10]),
    );
  }
  ...
  BridgeLlmEdit dco_decode_bridge_llm_edit(dynamic raw) {
    ...
    return BridgeLlmEdit(
      ...
      model: dco_decode_String(arr[2]),
      format: dco_decode_String(arr[3]),
      thinkingFields: dco_decode_bool(arr[4]),
      bodyJson: dco_decode_opt_String(arr[5]),
      thinkingOnJson: dco_decode_opt_String(arr[6]),
      thinkingOffJson: dco_decode_opt_String(arr[7]),
      apiKey: dco_decode_bridge_key_edit(arr[8]),
    );
  }
  ...
  BridgeLlmPreset dco_decode_bridge_llm_preset(dynamic raw) {
    ...
    return BridgeLlmPreset(
      name: dco_decode_String(arr[0]),
      format: dco_decode_String(arr[1]),
      baseUrl: dco_decode_String(arr[2]),
      model: dco_decode_String(arr[3]),
      thinkingFields: dco_decode_bool(arr[4]),
      thinkingOnJson: dco_decode_String(arr[5]),
      thinkingOffJson: dco_decode_String(arr[6]),
    );
  }
  ...
  BridgeRectifyBehavior dco_decode_bridge_rectify_behavior(dynamic raw) {
    ...
    return BridgeRectifyBehavior(
      ...
      connectionThinking: dco_decode_String(arr[10]),
    );
  }
  ...
  BridgeScenario dco_decode_bridge_scenario(dynamic raw) {
    ...
    return BridgeScenario(
      ...
      directive: dco_decode_String(arr[2]),
    );
  }
  ...
  BridgeSessionStyle dco_decode_bridge_session_style(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 1:
        return BridgeSessionStyle_Directive(
          text: dco_decode_String(raw[1]),
          scenario: dco_decode_opt_String(raw[2]),
        );
      case 2:
  ...
  List<BridgeLlmPreset> dco_decode_list_bridge_llm_preset(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_llm_preset).toList();
  }
  ...
  BridgeHistoryFilter sse_decode_box_autoadd_bridge_history_filter(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_history_filter(deserializer));
  }
  ...
  BridgeCommand sse_decode_bridge_command(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 6:
        ...
        var var_scenario = sse_decode_opt_String(deserializer);
        return BridgeCommand_SetStyleDirective(
      ...
      case 11:
        ...
        var var_sourceSessionId = sse_decode_opt_box_autoadd_i_64(deserializer);
        return BridgeCommand_RectifyText(
          rawTranscript: var_rawTranscript,
          style: var_style,
          sourceSessionId: var_sourceSessionId,
        );
      default:
        throw UnimplementedError('');
    }
  ...
  BridgeEvent sse_decode_bridge_event(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 6:
        var var_delta = sse_decode_String(deserializer);
        return BridgeEvent_RectifyThinkingDelta(delta: var_delta);
      case 7:
  ...
  BridgeHistoryEntry sse_decode_bridge_history_entry(
    ...
    var var_scenarioId = sse_decode_opt_box_autoadd_i_64(deserializer);
    return BridgeHistoryEntry(
      id: var_id,
      createdAtMs: var_createdAtMs,
      rawTranscript: var_rawTranscript,
      rectifiedText: var_rectifiedText,
      scenarioId: var_scenarioId,
    );
  }
  ...
  BridgeHistoryFilter sse_decode_bridge_history_filter(
    ...
    switch (tag_) {
      ...
      case 2:
        ...
        return BridgeHistoryFilter_Scenario(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  BridgeLlmConnection sse_decode_bridge_llm_connection(
    ...
    var var_thinkingState = sse_decode_String(deserializer);
    var var_thinkingDetail = sse_decode_opt_String(deserializer);
    var var_bodyJson = sse_decode_opt_String(deserializer);
    var var_thinkingOnJson = sse_decode_opt_String(deserializer);
    var var_thinkingOffJson = sse_decode_opt_String(deserializer);
    return BridgeLlmConnection(
      vendor: var_vendor,
      baseUrl: var_baseUrl,
      model: var_model,
      ...
      key: var_key,
      keys: var_keys,
      thinkingState: var_thinkingState,
      thinkingDetail: var_thinkingDetail,
      bodyJson: var_bodyJson,
      thinkingOnJson: var_thinkingOnJson,
      thinkingOffJson: var_thinkingOffJson,
    );
  }
  ...
  BridgeLlmEdit sse_decode_bridge_llm_edit(SseDeserializer deserializer) {
    ...
    var var_model = sse_decode_String(deserializer);
    var var_format = sse_decode_String(deserializer);
    var var_thinkingFields = sse_decode_bool(deserializer);
    var var_bodyJson = sse_decode_opt_String(deserializer);
    var var_thinkingOnJson = sse_decode_opt_String(deserializer);
    var var_thinkingOffJson = sse_decode_opt_String(deserializer);
    var var_apiKey = sse_decode_bridge_key_edit(deserializer);
    return BridgeLlmEdit(
      ...
      model: var_model,
      format: var_format,
      thinkingFields: var_thinkingFields,
      bodyJson: var_bodyJson,
      thinkingOnJson: var_thinkingOnJson,
      thinkingOffJson: var_thinkingOffJson,
      apiKey: var_apiKey,
  ...
  BridgeLlmPreset sse_decode_bridge_llm_preset(SseDeserializer deserializer) {
    ...
    var var_model = sse_decode_String(deserializer);
    var var_thinkingFields = sse_decode_bool(deserializer);
    var var_thinkingOnJson = sse_decode_String(deserializer);
    var var_thinkingOffJson = sse_decode_String(deserializer);
    return BridgeLlmPreset(
      name: var_name,
      format: var_format,
      baseUrl: var_baseUrl,
  ...
  BridgeRectifyBehavior sse_decode_bridge_rectify_behavior(
    ...
    var var_connectionThinking = sse_decode_String(deserializer);
    return BridgeRectifyBehavior(
      ...
      connectionThinking: var_connectionThinking,
    );
  }
  ...
  BridgeScenario sse_decode_bridge_scenario(SseDeserializer deserializer) {
    ...
    return BridgeScenario(id: var_id, name: var_name, directive: var_directive);
  }
  ...
  List<BridgeLlmPreset> sse_decode_list_bridge_llm_preset(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeLlmPreset>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_llm_preset(deserializer));
    }
    return ans_;
  }
  ...
  void sse_encode_box_autoadd_bridge_history_filter(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_history_filter(self, serializer);
  }
  ...
  void sse_encode_bridge_command(BridgeCommand self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case BridgeCommand_UpdatePreviewText(text: final text):
        ...
        sse_encode_String(text, serializer);
      case BridgeCommand_SetStyleDirective(
        directive: final directive,
        scenario: final scenario,
      ):
        sse_encode_i_32(6, serializer);
        sse_encode_opt_String(directive, serializer);
        sse_encode_opt_String(scenario, serializer);
      ...
      case BridgeCommand_RectifyText(
        ...
        sse_encode_opt_box_autoadd_i_64(sourceSessionId, serializer);
    }
  }
  ...
  void sse_encode_bridge_event(BridgeEvent self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case BridgeEvent_RectifyThinkingDelta(delta: final delta):
        sse_encode_i_32(6, serializer);
        sse_encode_String(delta, serializer);
  ...
  void sse_encode_bridge_history_entry(
    ...
    sse_encode_opt_box_autoadd_i_64(self.scenarioId, serializer);
  }
  ...
  void sse_encode_bridge_history_filter(
    ...
    switch (self) {
      case BridgeHistoryFilter_All():
        sse_encode_i_32(0, serializer);
      case BridgeHistoryFilter_DefaultRegister():
        sse_encode_i_32(1, serializer);
      case BridgeHistoryFilter_Scenario(field0: final field0):
        sse_encode_i_32(2, serializer);
  ...
  void sse_encode_bridge_llm_connection(
    ...
    sse_encode_String(self.thinkingState, serializer);
    sse_encode_opt_String(self.thinkingDetail, serializer);
    sse_encode_opt_String(self.bodyJson, serializer);
    sse_encode_opt_String(self.thinkingOnJson, serializer);
    sse_encode_opt_String(self.thinkingOffJson, serializer);
  }
  ...
  void sse_encode_bridge_llm_edit(
    ...
    sse_encode_String(self.model, serializer);
    sse_encode_String(self.format, serializer);
    sse_encode_bool(self.thinkingFields, serializer);
    sse_encode_opt_String(self.bodyJson, serializer);
    sse_encode_opt_String(self.thinkingOnJson, serializer);
    sse_encode_opt_String(self.thinkingOffJson, serializer);
    sse_encode_bridge_key_edit(self.apiKey, serializer);
  ...
  void sse_encode_bridge_llm_preset(
    ...
    sse_encode_String(self.model, serializer);
    sse_encode_bool(self.thinkingFields, serializer);
    sse_encode_String(self.thinkingOnJson, serializer);
    sse_encode_String(self.thinkingOffJson, serializer);
  }
  ...
  void sse_encode_bridge_rectify_behavior(
    ...
    sse_encode_String(self.connectionThinking, serializer);
  }
  ...
  void sse_encode_bridge_session_style(
    ...
    switch (self) {
      case BridgeSessionStyle_Live():
        sse_encode_i_32(0, serializer);
      case BridgeSessionStyle_Directive(
        text: final text,
        scenario: final scenario,
      ):
        sse_encode_i_32(1, serializer);
  ...
  void sse_encode_list_bridge_llm_preset(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_llm_preset(item, serializer);
    }
  }
