#!/usr/bin/env bash
# Nightly fidelity-eval entry point. Writes a dated report
...
# errors.
#
# WSL cron line (<repo> is the checkout root, <distro> the WSL name):
#   17 3 * * * <repo>/scripts/nightly-eval.sh
#
...
#     /TR "wsl.exe -d <distro> -e bash <repo>/scripts/nightly-eval.sh"
